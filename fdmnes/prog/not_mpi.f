...
!----------------------------------------------------------------------
      subroutine MPI_BCAST(ivar,idim,MPI_INTEGER,ii,MPI_COMM_WORLD,
     &                     mpierr)
      dimension ivar(idim)
      mpierr = 0
      return
...
!----------------------------------------------------------------------
      subroutine MPI_SEND(ivar,idim,MPI_INTEGER,mpirank,i,
...
!----------------------------------------------------------------------
      subroutine MPI_RECV(ivar,idim,MPI_INTEGER,mpirank,i,
     &                    MPI_COMM_WORLD,mstatus,mpierr)
      dimension ivar(idim)
      mpierr = 0
      mstatus = 0
      i = 0
...
!----------------------------------------------------------------------
      subroutine MPI_GATHER(MPI_IN_PLACE,idim,MPI_INTEGER,var,
     &                      idim1,MPI_REAL8,i,MPI_COMM_WORLD,mpierr)
      dimension var(idim)
      mpierr = 0
      i = 0
      return
